...
public class UserReportGenerator {
    ...
    public void export(String outputPath, UserRepository userRepository) {
        try {
            ...
            System.out.println("Reporte de usuarios generado exitosamente en: " + outputPath);
    ...
    private void loadCompiledReport() throws JRException {
        ...
        if (resourceUrl != null) {
            ...
            try (InputStream jasperStream = resourceUrl.openStream()) {
                ...
                throw new JRException("Error al cargar el archivo users-report.jasper", e);
            }
        } else {
            throw new JRException("No se encontró el archivo users-report.jasper");
        }
    }
}